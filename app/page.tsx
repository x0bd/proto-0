                ...
                <div className="relative flex flex-col lg:flex-row gap-10 lg:gap-16 items-start">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        >
                            ...
                            <span className="te-label text-[var(--te-orange)]">XOBOID.SYS — PROTO.0</span>
                        </motion.div>

                        {/* Staggered headline */}
                        <h1 className="relative font-mono font-black leading-[1.0] tracking-[-0.025em] mb-9">
                            <motion.span
                            ...
                            <motion.span
                                ...
                                style={{ fontSize: "clamp(54px, 9vw, 112px)" }}
                            >
                                One face.
                            </motion.span>
                            <motion.span
                        ...
                        <motion.p
                            ...
                            className="font-mono text-[14px] text-[#888] leading-[1.8] max-w-[420px] mb-10"
                        >
                            An open-source AI companion with a procedural face.
                            Runs entirely in your browser — no cloud, no lock-in.
                        </motion.p>
                    ...
                    >
                        <div className="te-panel rounded-[14px] overflow-hidden">
                            <div className="te-module-header px-4 py-2.5">
                                <span className="te-label">DOT_SPEC</span>
                            ...
                            <div className="divide-y divide-[var(--panel-border)]">
                                {[
                                    ...
                                    <motion.div
                                        ...
                                        className="flex items-center justify-between px-4 py-3 group hover:bg-black/[0.02] transition-colors"
                                    >
                                        <span className="te-label">{k}</span>
                                        <span className="font-mono text-[10px] font-black tracking-[0.08em] text-[#111] group-hover:text-[var(--te-orange)] transition-colors">{v}</span>
                                    </motion.div>
                                ))}
                            </div>
                        </div>
