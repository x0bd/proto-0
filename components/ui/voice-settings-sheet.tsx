        ...
        <AnimatePresence>
            {open && (
                <motion.div
                    ...
                    className="absolute top-24 left-1/2 -translate-x-1/2 w-[340px] h-auto te-module te-safe-panel z-[100] flex flex-col"
                >
                    {/* Header / Drag Handle */}
                    <div className="te-module-header">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="font-mono text-[8px] uppercase tracking-widest te-whisper ml-2">V-1.4</span>
                        </div>
